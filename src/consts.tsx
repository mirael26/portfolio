...
export const portfolioData = [
  {
    title: 'Camera shop',
    description: 'Интернет-магазин фото- и видеокамер.\nКаталог с сортировкой, фильтрацией и пагинацией.\nВ проекте реализованы поиск товаров по сайту, корзина с промокодом, форма добавления отзыва. Фильтры и страницы сохраняются в адресной строке с помощью строки запроса. Промо-баннер, товары и промокод запрашиваются с сервера с помощью REST API.\nПроект полностью покрыт юнит-тестами.\n\nСтек: TypeScript, React, Redux, Axios, Jest',
  ...
  },
  {
    ...
    description: 'Тестовое задание, содержащее страницу авторизации и книгу контактов.\nРеализована форма логина и регистрации, возможность добавления, удаления и редактирования контактов, поиска по контактам. Для формы регистрации и добавления контакта настроена валидация.\n\nСтек: React, Redux, TypeScript, SCSS, fake-json-server, Material UI',
  ...
  {
    title: 'Escape Room',
    description: 'Каталог квестов с фильтрацией по жанрам, формой заявки и страницей контактов.\nНа форме заявки реализована валидация.\nВ страницу контактов встроена 2-gis карта.\n\nСтек: TypeScript, React, Redux, Axios',
